...
const mongoUri = 'mongodb+srv://RodriAlon:Ambar2022@cluster0.jjlda.mongodb.net/carlog?retryWrites=true&w=majority';
...
async function importAllJsonFiles(baseDir) {
  ...
  console.log(`🔍 Encontrados ${filesToImport.length} archivos JSON para importar.`);
